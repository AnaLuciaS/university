...
class ClassroomsControllerTest < ActionController::TestCase
  ...
  test "should create classroom" do
    assert_difference('Classroom.count') do
      post :create, classroom: { courses_id: @classroom.courses_id, entry_at: @classroom.entry_at, student_id: @classroom.student_id }
    end
  ...
  test "should update classroom" do
    patch :update, id: @classroom, classroom: { courses_id: @classroom.courses_id, entry_at: @classroom.entry_at, student_id: @classroom.student_id }
    assert_redirected_to classroom_path(assigns(:classroom))
  end
